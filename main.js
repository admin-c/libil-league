// ===== КОНФИГУРАЦИЯ API =====
// ВАЖНО: Замените эти значения на ваши, полученные из GitHub!
const CONFIG = {
    GIST_ID: 'abc123', // Замените на ID вашего Gist
    GITHUB_TOKEN: 'github_pat_123...', // Замените на ваш токен
    FILE_NAME: 'data.json'
};

// Базовый URL для запросов к GitHub API через прокси (Render.com будет обслуживать)
const API_BASE = window.location.origin; // Будет работать на вашем домене Render.com
